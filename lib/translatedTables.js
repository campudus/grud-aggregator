...
exports.tablesForLanguages = tablesForLanguages;
...
function tablesForLanguages(tablesObj, langtags) {
    ...
    return Object.assign(acc, _defineProperty({}, language, _lodash2.default.mapValues(tablesObj, function (table) {
      return {
        ...
        rows: _lodash2.default.transform(table.rows, function (rows, row) {
          rows[row.id] = _lodash2.default.flatMap(table.columns, function (c, index) {
            if (c.kind === 'concat') {
              return [];
