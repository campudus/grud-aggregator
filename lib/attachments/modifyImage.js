    ...
    return Promise.resolve({
      ...
      return _lodash.default.reduce(chunkedFiles, function (promise, chunkFiles) {
        return promise.then(function (stepAndFiles) {
          ...
          var doing = resize && minify && trim ? "Resizing, trimming and minifying" : resize && minify ? "Resizing and minifying" : resize && trim ? "Resizing and trimming" : minify && trim ? "Minifying and trimming" : resize ? "Resizing" : minify ? "Minifying" : "Trimming";
