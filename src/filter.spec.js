...
import cyclicTablesFixture from "./__tests__/cyclicTablesFixture.json" with { type: "json" };
import cyclicTablesWithDependencyLinkFixture from "./__tests__/cyclicTablesWithDependencyLinkFixture.json" with { type: "json" };
import filterFixture0 from "./__tests__/filterFixture0.json" with { type: "json" };
import filterFixture1 from "./__tests__/filterFixture1.json" with { type: "json" };
import filterFixture2 from "./__tests__/filterFixture2.json" with { type: "json" };
import filterFixture3 from "./__tests__/filterFixture3.json" with { type: "json" };
import filterFixture4 from "./__tests__/filterFixture4.json" with { type: "json" };
import filterFixture5 from "./__tests__/filterFixture5.json" with { type: "json" };
import filterFixture6 from "./__tests__/filterFixture6.json" with { type: "json" };
import filterFixture7 from "./__tests__/filterFixture7.json" with { type: "json" };
import filterFixture8 from "./__tests__/filterFixture8.json" with { type: "json" };
import filterFixture9 from "./__tests__/filterFixture9.json" with { type: "json" };
import filterFixture10 from "./__tests__/filterFixture10.json" with { type: "json" };
import filterFixture11 from "./__tests__/filterFixture11.json" with { type: "json" };
