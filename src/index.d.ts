...
export type Attachment<IsMultiLang = true> = Prettify<{
  ...
  description: IsMultiLang extends true
    ? MultilangValue<Langtag, string>
    : string;
  internalName: IsMultiLang extends true
    ? MultilangValue<Langtag, string>
    : string;
  externalName: IsMultiLang extends true
    ? MultilangValue<Langtag, string>
    : string;
...
> = Tuple<{
  [Index in Col["index"]]: RowValue<
    TName,
    Extract<Col, { index: Index }>["name"]
  >;
}>;
...
> = {
  boolean: IsMultiLang extends true
    ? MultilangValue<Langtag, boolean>
    : boolean | null;
  shorttext: IsMultiLang extends true
    ? MultilangValue<Langtag, string>
    : string | null;
...
> = Prettify<
  {
    [Id in TLinkIds]: Id extends TLinks
      ? never
      : Id | LinkedTableId<Id, TLinks | Id>;
  }[TLinkIds]
>;
...
> = {
  ...
  shorttext: IsMultiLang | UseMultiLang extends true
    ? MultilangValue<Langtag, string>
    : string | null;
  text: IsMultiLang | UseMultiLang extends true
    ? MultilangValue<Langtag, string>
    : string | null;
...
export type TableEntitiesReferenced<
  TName extends TableName = TableName,
